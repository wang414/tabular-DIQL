...
class QMIX:
    def __init__(self, args):
        ...
        print('eval_rnn = {}'.format(self.eval_rnn))
        print('eval_qmix_net = {}'.format(self.eval_qmix_net))
        self.args = args
        if self.args.cuda:
            self.eval_rnn.cuda()
        ...
        if args.optimizer == "RMS":
            if args.check_qmix:
                final_lr = args.lr_for_qmix
            else:
                final_lr = args.lr
            self.optimizer = torch.optim.RMSprop(self.eval_parameters, lr=final_lr)
    ...
    def init_hidden(self, episode_num):
        ...
        rnn_dim = self.args.rnn_hidden_dim
        self.eval_hidden = torch.zeros((episode_num, self.n_agents, rnn_dim))
        self.target_hidden = torch.zeros((episode_num, self.n_agents, rnn_dim))
