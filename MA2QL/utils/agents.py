...
from utils.policies import DiscretePolicy,BasePolicy
...
class AttentionAgent(object):
    ...
    def __init__(self, num_in_pol, num_out_pol, hidden_dim=64,
        ...
        """
        self.policy = BasePolicy(num_in_pol, num_out_pol,
                                     hidden_dim=hidden_dim,
                                     onehot_dim=onehot_dim).double()
        self.target_policy = BasePolicy(num_in_pol,
                                            num_out_pol,
                                            hidden_dim=hidden_dim,
                                            onehot_dim=onehot_dim).double()
